...
If this is your first approach with Orion Context Broker, it is highly recommended to have a look to the brief [Quick Start guide](quick_start_guide.md).

## Build and Install

The recommended procedure is to install using RPM packages in CentOS 6.x. If you are interested in
building from sources, check [this document](../admin/build_source.md).

### Requirements

* System resources: see [these recommendations](../admin/resources.md#resources-recommendations)
...
* [Upgrading to 0.14.1 and beyond from a pre-0.14.1 version](../admin/upgrading_crossing_0-14-1.md)
* [Upgrading to 0.19.0 and beyond from a pre-0.19.0 version](../admin/upgrading_crossing_0-19-0.md)
* [Upgrading to 0.21.0 and beyond from a pre-0.21.0 version](../admin/upgrading_crossing_0-21-0.md)
...
Please have a look to the [Quick Start guide](quick_start_guide.md) if you want to test these operations in an actual public instance of Oriion Context Broker. In addition, have a look to the API Walkthrough and API Reference sections below in order to know more details about the API (subscriptions, registrations, etc.).

## API Walkthrough

* [FIWARE NGSI v1](../user/walkthrough_apiv1.md) (Markdown)
...
* Installation and administration
	...
	* [Logs](../admin/logs.md)
	* [Watchdog](../admin/watchdog.md)
	* [Rush relayer](../admin/rush.md)
	* [Management REST inferface](../admin/management_api.md)   
	* [Data model](../admin/database_model.md)
	* [Resources & I/O Flows](../admin/resources.md) 
	* [Problem diagnosis procedures](../admin/diagnosis.md)
...
* API
    ...
    * [Context Providers registration and request forwarding](../user/context_providers.md)
	* [Attribute metadata](../user/metadata.md)
	* [Filtering results](../user/filtering.md)
	* [Multy tenancy](../user/multitenancy.md)
	* [Entity service paths](../user/service_path.md)
	* [Adding and removing attributes and entities with APPEND and DELETE in updateContext](../user/append_and_delete.md)
	* [Updating registrations and subscriptions](../user/updating_regs_and_subs.md)	 
	* [Context broker federation](../user/federation.md)
	* [Forbidden characters](../user/forbidden_characters.md)
	* [Duration (for registration and subscriptions)](../user/duration.md)
	* [Using empty types](../user/empty_types.md)
	* [Mixing standard and convenience operations](../user/std_conv_mix.md)
	* [HTTP and NGSI response codes](../user/http_and_ngsi_sc.md)
	* [Security considerations](../user/security.md)
	* [Known limitations](../user/known_limitations.md)

* Container-based deployment
	* [Vagrant](vagrant.md) 

* [Sample code contributions](code_contributions.md)
